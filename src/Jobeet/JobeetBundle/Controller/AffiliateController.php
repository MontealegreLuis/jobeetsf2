...
namespace Jobeet\JobeetBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Jobeet\JobeetBundle\Entity\Affiliate;
use Jobeet\JobeetBundle\Form\AffiliateType;
...
class AffiliateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JobeetJobeetBundle:Affiliate')->findAll();

        return $this->render('JobeetJobeetBundle:Affiliate:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('JobeetJobeetBundle:Affiliate:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JobeetJobeetBundle:Affiliate')->find($id);
        ...
        return $this->render('JobeetJobeetBundle:Affiliate:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('JobeetJobeetBundle:Affiliate:edit.html.twig', array(
            'entity'      => $entity,
